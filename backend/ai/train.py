...
model.tune(data='./data/duomo/data.yaml', epochs=30, iterations=300, optimizer='AdamW', plots=False, save=False, val=False)

model = YOLO('yolov8n.pt')
model.tune(data='./data/hadji_dimitar_square/data.yaml', epochs=30, iterations=300, optimizer='AdamW', plots=False, save=False, val=False)

model = YOLO('yolov8n.pt')
model.tune(data='./data/keskvaljak/data.yaml', epochs=30, iterations=300, optimizer='AdamW', plots=False, save=False, val=False)

model = YOLO('yolov8n.pt')
model.tune(data='./data/kielce_university_of_technology/data.yaml', epochs=30, iterations=300, optimizer='AdamW', plots=False, save=False, val=False)
