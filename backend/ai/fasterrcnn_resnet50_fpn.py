...
PRE_TRAINED_BOOL = True):
    ...
    model = torchvision.models.detection.fasterrcnn_resnet50_fpn(pretrained=PRE_TRAINED_BOOL)
    ...
    def evaluate(model, data_loader, device):
        ...
        plt.ylabel('F1 Score')
        plt.legend()
        plt.savefig(f'fasterrcnn_resnet50_fpn_{PRE_TRAINED_BOOL}_{EPOCHS}_{VAL_IMAGES.replace("/", "-").replace(".", "")}_f1_over_confidence')
        ...
        plt.legend()
        plt.savefig(f'fasterrcnn_resnet50_fpn_{PRE_TRAINED_BOOL}_{EPOCHS}_{VAL_IMAGES.replace("/", "-").replace(".", "")}_precision_over_recall')
        ...
        plt.ylabel('Precision')
        plt.legend()
        plt.savefig(f'fasterrcnn_resnet50_fpn_{PRE_TRAINED_BOOL}_{EPOCHS}_{VAL_IMAGES.replace("/", "-").replace(".", "")}_precision_over_confidence')
        ...
        plt.ylabel('Recall')
        plt.legend()
        plt.savefig(f'fasterrcnn_resnet50_fpn_{PRE_TRAINED_BOOL}_{EPOCHS}_{VAL_IMAGES.replace("/", "-").replace(".", "")}_recall_over_confidence')
